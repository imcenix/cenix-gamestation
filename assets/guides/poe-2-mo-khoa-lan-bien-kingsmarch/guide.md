---
title: "Path of Exile 2: Mở khoá Lặn Biển — chuỗi quest Ruins of Kingsmarch"
slug: poe-2-mo-khoa-lan-bien-kingsmarch
level: endgame
date: 2026-08-30
featured: true
order:
tags:
  ...
  - ENDGAME
  - LẶN BIỂN
excerpt: Muốn lặn biển kiếm Div thì phải qua cửa Ruins of Kingsmarch trước. Bốn quyển logbook, bốn con boss, một mảnh Triskelion vỡ — Cenix dẫn anh em đi từng chặng.
cover: cover.png
---
...
![Ruins of Kingsmarch trong Path of Exile 2](ruins-kingsmarch.png)

<div class="editorial-text-box" data-bg="#e8f8ef" data-color="#2d3458" style="--box-bg: #e8f8ef; --box-color: #2d3458;"><p><strong>Tìm chỗ bắt đầu:</strong> <strong>Ruins of Kingsmarch</strong> nằm ở phía <strong>đông nam</strong> của <strong>Ziggurat Refuge</strong>. Đây là nội dung endgame, tên chính thức của chuỗi quest là <strong>The Grand Expedition</strong>.</p></div>

## <span style="color:rgb(255, 176, 0)">Mở màn — gặp mặt cho đủ người</span>
...
## <span style="color:rgb(255, 176, 0)">Chặng chính — bốn quyển logbook, bốn con boss</span>

![Các loại logbook trong Path of Exile 2](logbook-icons.png)
...
### <span style="color:rgb(200, 240, 60)">Bốn bước lặp lại ở mỗi hòn đảo</span>
...
<div class="editorial-text-box" data-bg="#fff4e0" data-color="#2d3458" style="--box-bg: #fff4e0; --box-color: #2d3458;"><p><strong>Cenix mách nhỏ:</strong> Bốn con boss này về sau vẫn gặp lại trong Grand Expedition thường — <strong>Medved</strong>, <strong>Vorana</strong>, <strong>Uhtred</strong> và <strong>Olroth</strong> đều có "tin đồn" riêng để triệu ra. Nên lần đầu đánh cứ nhớ kỹ bài của từng đứa, về sau đỡ mất máu.</p></div>

## <span style="color:rgb(255, 176, 0)">Chặng cuối — ra khơi bằng tàu Aurora May</span>
...
## <span style="color:rgb(255, 176, 0)">Lặn biển là gì và mở ra rồi thì làm gì</span>

![Grand Expedition đã kích hoạt trên Atlas](logbook-activated.png)
...
![Biểu tượng Grand Expedition](grand-expedition-icon.png)
